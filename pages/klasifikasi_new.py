...
def setup_visual_builder():
    ...
    col = st.columns([3,1], vertical_alignment="center")

    with col[0]:
        st.html("<h3 style='color: #666566; font-weight: 900;'>Konfigurasi Node :</h3>")
    with col[1]:
        popover = st.popover("Filter Node", icon=":material/filter_alt:", use_container_width=True)

        popover.checkbox("By Kamus Data", True)
        popover.checkbox("By Patter", True)
